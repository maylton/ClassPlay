...
export default function Home() {
  return <main className="landing-shell">
    <nav className="landing-nav"><Brand /><div className="landing-public-links"><Link href="/community">Community</Link><Link href="/class/join">Join a class</Link><Link className="button button-ghost" href="/dashboard">Teacher dashboard</Link></div></nav>
    <section className="hero"><div className="hero-copy"><span className="eyebrow"><span className="status-dot" /> Built for the classroom</span><h1>One activity.<br/><span>Many ways to play.</span></h1><p>Create beautiful English activities once, then reuse the same content across different game modes — from flashcards and memory to quizzes and more.</p><div className="hero-actions"><Link className="button button-primary button-large" href="/dashboard">Start teaching <AppIcon name="arrow-right" /></Link><Link className="button button-soft button-large" href="/community"><AppIcon name="globe2" /> Play free activities</Link></div><div className="hero-note">Community games are free to play · Student accounts keep classes and homework connected</div></div>

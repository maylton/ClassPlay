...
export default function Home() {
  return <main className="landing-shell">
    ...
    <section className="hero"><div className="hero-copy"><span className="eyebrow"><span className="status-dot" /> Built for the classroom</span><h1>One activity.<br/><span>Six ways to play.</span></h1><p>Create beautiful English activities once, then reuse the same content as flashcards, memory, matching, sentence building, gap fill and quizzes.</p><div className="hero-actions"><Link className="button button-primary button-large" href="/dashboard">Start teaching <AppIcon name="arrow-right" /></Link><Link className="button button-soft button-large" href="/play/daily-routine-present-simple">Try demo</Link></div><div className="hero-note">No account required for local play · Teacher accounts unlock cloud and live rooms</div></div>

...
export function QuizGame({ activity, onComplete }: GameProps) {
  ...
  function replay() {
    setQuestions(shuffle(playableItems)); setIndex(0); setCorrect(0); setScore(0); setStreak(0); setSelected(null); setFinished(false); setQuestionElapsedMs(0); setLastPoints(0);
  }
